          ...
          </div>
          {
            editing ?
              <form className='flex flex-col w-full items-end gap-4' onSubmit={(e) => handleSubmit(e)}>
                ...
                <input onClick={(e) => editComment(e)} className='rounded-md bg-moderate-blue hover:bg-light-grayish-blue text-white px-6 py-3 w-fit h-fit font-medium cursor-pointer select-none' type="submit" value="EDIT" />
              </form> :
